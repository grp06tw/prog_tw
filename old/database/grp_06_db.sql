...
--
-- Host: 127.0.0.1
-- Creato il: Giu 08, 2017 alle 09:27
...
--
ALTER TABLE `azienda`
  MODIFY `ID_Azienda` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `coupon`
  MODIFY `ID_Coupon` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `promozione`
  MODIFY `ID_Promozione` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
